...
export default function ManageEstimate() {
  ...
  const handleChange = (e) => {
    ...
    setForm((prev) => {
      ...
      if (name === "qty" || name === "costPerUnit") {
        ...
        updated.totalCost =
          qty && cpu ? (parseFloat(qty) * parseFloat(cpu)).toFixed(2) : "";
      }
      return updated;
    });
  };
  ...
  const handleGenerateInvoice = (est) => {
    navigate("/create-invoice", { state: { estimate: est } });
  };
    ...
    >
      ...
      <div style={{ flex: 1, padding: "24px" }}>
        ...
        <div style={{ marginBottom: "16px" }}>
          <button onClick={openAddModal} style={createBtn}>
            + Create Estimate
          </button>
        </div>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((est, idx) => (
                  <tr key={est.estimatedId} style={{ borderBottom: "1px solid #f0f0f0" }}>
                    ...
                    <td style={td}>
                      <button onClick={() => openEditModal(est)} style={editBtn}>
                        Edit
                      </button>
                    </td>
                    <td style={td}>
                      <button
                        onClick={() => confirmDelete(est.estimatedId)}
                        style={deleteBtn}
                      >
                        Delete
                      </button>
                    ...
                    <td style={td}>
                      <button
                        onClick={() => handleGenerateInvoice(est)}
                        style={generateBtn}
                      >
                        Generate
                      </button>
        ...
        <div style={overlay}>
          <div style={modal}>
            ...
            >
              ...
              <div>
                <label style={labelStyle}>Select Chain ID or Company Name:</label>
                <select
                  name="chainId"
                  value={form.chainId}
                  onChange={handleChange}
              ...
              <div>
                <label style={labelStyle}>Estimated Amount in Rs:</label>
                <input
                  name="totalCost"
